...
#define EASEL_ES920_RECV_MAX_SIZE 62		///< RecvTelegram Max Data
...
extern int easel_ES920_set_only( int node, int bw, int sf, int ch, int panid, int ownid, int dstid, int acksw, int ackRetryNum, int trmode, int rcvsw, int rssisw, int brate, int slepsw, int slepNum, int outpw);
extern void easel_ES920_set_load();
extern void easel_ES920_set_operation();
#endif
